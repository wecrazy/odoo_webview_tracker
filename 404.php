...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="public/assets/" data-template="horizontal-menu-template">
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <h4 class="mb-2 mx-2">Oops!</h4>
            <p class="mb-6 mx-2">Request not Found</p>

            <div class="d-flex flex-column align-items-center gap-6">
                <h3 class="mb-1 text-">
                    <button class="btn btn-sm btn-danger"
                        disabled><?php echo htmlspecialchars($_SERVER['REQUEST_METHOD']); ?></button> &nbsp;
                    <mark><?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?></mark>
                </h3>
            </div>
            ...
            <div class="mt-3">
                <img src="public/assets/img/illustrations/page-misc-error-light.png" alt="page-misc-error-light"
