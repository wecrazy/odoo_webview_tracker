...
class refreshTechnicianDataScheduler
{
    private $log;
    private $config;
    private $error;
    ...
    public function refreshData() {
        $response = $this->techLoginInstance->getListActiveTechnicians();
        if ($response) {
            $this->log->createLogMessage("--- SUCCESS : All Technicians Data Success Updated!");
        }
    }
}

$techniciansInstance = new refreshTechnicianDataScheduler();
